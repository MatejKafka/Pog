...
function RetrievePackageVersions([Pog.PackageGenerator]$Generator) {
	foreach ($Obj in & $Generator.Manifest.ListVersionsSb) {
...
function UpdateSinglePackage([string]$PackageName, [string[]]$Version,  [switch]$Force, [switch]$ListOnly) {
	...
	$GeneratedVersions = RetrievePackageVersions $g `
